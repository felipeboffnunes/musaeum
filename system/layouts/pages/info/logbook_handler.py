...
class LogBook_Handler():
    ...
    def consume_data(self, date_str: str) -> list:
        ...
        result: list = [html.Div([
            dbc.Row([
                dbc.Col([
                    ...
                    dcc.DatePickerSingle(
                        ...
                        min_date_allowed=datetime.date(2021, 9, 22),
                        max_date_allowed=datetime.date(2021, 9, 23),
                        id='day-picker'
                    )
            ...
            dbc.Row([
                dbc.Col([
                    html.H4(["Activities", html.Img(src="./assets/images/icons/information-outline.svg", id="ACTINFO",
                                                    className="info-icon")]),
                    self._data(day, "ACT"),
                    html.Hr(),
                    html.H4(["Studies", html.Img(src="./assets/images/icons/information-outline.svg", id="STUINFO",
                                                 className="info-icon")]),
                    self._data(day, "STU")
                ], width=4),
                dbc.Col([
                ...
                dbc.Col([
                    html.H4(["Nutrition", html.Img(src="./assets/images/icons/information-outline.svg", id="NUTINFO",
                                                   className="info-icon")]),
                    dbc.Row([
                        dbc.Col([
                            dbc.Row([
                    ...
                    html.Hr(),
                    html.H4(["Exercises", html.Img(src="./assets/images/icons/information-outline.svg", id="EXEINFO",
                                                   className="info-icon")]),
                    dbc.Row([
                        dbc.Col([
                            self._data(day, "EXE")
    ...
    def _data(self, day: int, type_: str) -> Union[dbc.Row, html.Div]:
        ...
        def __health() -> list:
            ...
            if day_first_rows or day_second_rows:
                col = [dbc.Col(day_first_rows, width={"size": 5, "offset": 1}),
                       dbc.Col(day_second_rows, width={"size": 5})]
            else:
                col = [dbc.Col("No info.")]
            return col
